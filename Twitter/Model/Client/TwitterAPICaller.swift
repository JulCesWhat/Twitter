...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func favoriteTweet(tweetId: Int, shouldFavorite: Bool, success: @escaping () -> (), failure: @escaping (Error) -> ()){
        let url = shouldFavorite ? "https://api.twitter.com/1.1/favorites/create.json" : "https://api.twitter.com/1.1/favorites/destroy.json"
